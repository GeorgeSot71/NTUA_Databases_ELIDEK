...
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (55, 'Batteryless, Ambiently-Powered Internet of Things', 'Said his father; \'don\'t give yourself airs! Do you think I may as well say this), \'to go on with the other side will make you grow taller, and the happy summer days. THE.', '302999.99', '2017-08-01', '1979-06-12', 'RyanG', 5, 5, 55);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 

...
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (51, 'The Perils of Prediction in the Physical Science', 'Gryphon, before Alice could see, as well say,\' added the Gryphon; and then they both bowed low, and their curls got entangled together. Alice laughed so much into the court, \'Bring me the truth: did.', '866465.86', '2018-03-16', '2020-07-18', 'AaS', 1, 1, 51);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
...
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (53, 'Assistance for students in Singing and Music Aesthetics', 'Let me see--how IS it to annoy, Because he knows it teases.\' CHORUS. (In which the words \'DRINK ME,\' but nevertheless she uncorked it and put it in asking riddles that have no answers.\' \'If you.', '208999.99', '2020-10-20', '2023-09-30', 'AaS', 3, 3, 53);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (54, 'Sourcebook of Byzantine Philosophy (SBPh)', 'Alice: \'allow me to introduce it.\' \'I don\'t even know what they\'re like.\' \'I believe so,\' Alice replied very readily: \'but that\'s because it stays the same as the doubled-up soldiers were silent,.', '465349.92', '2018-12-08', '2021-11-15', 'AaS', 4, 4, 54);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (55, 'Batteryless, Ambiently-Powered Internet of Things', 'Said his father; \'don\'t give yourself airs! Do you think I may as well say this), \'to go on with the other side will make you grow taller, and the happy summer days. THE.', '302999.99', '2019-08-01', '2021-06-12', 'RyanG', 5, 5, 55);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (56, 'Development of tissue-engineered vascularized bone grafts', 'Beautiful, beauti--FUL SOUP!\' \'Chorus again!\' cried the Gryphon. Alice did not look at it!\' This speech caused a remarkable sensation among the branches, and every now and then sat upon it.) \'I\'m.', '230999.99', '2021-11-19', '2025-11-02', 'AaS', 6, 6, 56);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (57, 'Innovative Catalyst Design via 3D Printing', 'And she thought at first she thought it over here,\' said the March Hare interrupted, yawning. \'I\'m getting tired of this. I vote the young lady to see if he wasn\'t one?\' Alice asked. \'We called him.', '700772.84', '2019-11-14', '2022-01-23', 'RyanG', 7, 7, 57);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (58, 'Electrochemical Analysis for the action of Lytic Polysaccharide Monooxygenases', 'Gryphon, the squeaking of the tea--\' \'The twinkling of the other players, and shouting \'Off with his head!\' or \'Off with his head!\"\' \'How dreadfully savage!\' exclaimed Alice. \'And where HAVE my.', '420118.67', '2018-03-04', '2020-10-24', 'AaS', 8, 8, 58);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (59, 'Advanced photocatalytic Slow Photon nanostructures', 'Alice remarked. \'Right, as usual,\' said the Caterpillar; and it sat for a long time together.\' \'Which is just the case with my wife; And the moral of that dark hall, and wander about among those.', '420893.38', '2019-08-03', '2022-05-23', 'AaS', 9, 9, 59);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (60, 'Scaling stochastic dynamics', 'Who for such dainties would not open any of them. However, on the floor, and a scroll of parchment in the air. She did not like to try the experiment?\' \'HE might bite,\' Alice cautiously replied:.', '100056.52', '2018-08-27', '2021-08-22', 'AaS', 10, 10, 60);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (61, 'Finiteness Conditions in Homological Algebra', 'Gryphon, before Alice could see, as well say,\' added the Gryphon; and then they both bowed low, and their curls got entangled together. Alice laughed so much into the court, \'Bring me the truth: did.', '864965.86', '2019-03-16', '2021-07-18', 'AaS', 11, 11, 61);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (62, 'Dataflow optimization revisited', 'Bill\'s got to grow to my jaw, Has lasted the rest of it in a game of croquet she was dozing off, and found quite a long argument with the Lory, with a growl, And concluded the banquet--] \'What IS a.', '156999.00', '2020-12-19', '2022-01-05', 'RyanG', 12, 12, 62);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (63, 'A Toolkit for the Analysis and Synthesis of Soundscapes', 'Let me see--how IS it to annoy, Because he knows it teases.\' CHORUS. (In which the words \'DRINK ME,\' but nevertheless she uncorked it and put it in asking riddles that have no answers.\' \'If you.', '304999.99', '2019-10-20', '2021-09-30', 'RyanG', 13, 13, 63);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (64, 'Advanced Multi-Label Learning Techniques', 'Alice: \'allow me to introduce it.\' \'I don\'t even know what they\'re like.\' \'I believe so,\' Alice replied very readily: \'but that\'s because it stays the same as the doubled-up soldiers were silent,.', '203349.92', '2019-12-08', '2021-11-15', 'RyanG', 14, 14, 64);
INSERT INTO `project` (`project_id`, `title`, `summary`, `funding`, `start_date`, `end_date`, `abbreviation`, `executive_id`, `program_id`, `scientific_inspector_id`) 
    VALUES (65, 'Inflationary models in the lhc and planck era', 'Said his father; \'don\'t give yourself airs! Do you think I may as well say this), \'to go on with the other side will make you grow taller, and the happy summer days. THE.', '100999.99', '2019-08-01', '2022-02-12', 'RyanG', 15, 15, 65);
...
/* 
exoume 65 project kai 100 researchers => 
ta 30 prwta project exoun 2 works on 
ta alla 35 exoun 
*/
